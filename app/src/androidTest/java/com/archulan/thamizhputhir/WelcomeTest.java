...
public class WelcomeTest {
    ...
    public void welcomeTest() {
        ...
        ViewInteraction textInputEditText4 = onView(
                allOf(withId(R.id.cell2),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText4.perform(replaceText("சா"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText6 = onView(
                allOf(withId(R.id.cell1),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText6.perform(replaceText("வி"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton8 = onView(
                allOf(withId(R.id.button), withText("Picture Puzzle"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textInputEditText10 = onView(
                allOf(withId(R.id.picAnswer),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText10.perform(replaceText("அன்னாசி"), closeSoftKeyboard());

        ViewInteraction textInputEditText11 = onView(
                allOf(withId(R.id.picAnswer), withText("அன்னாசி"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
        ...
        ViewInteraction appCompatButton14 = onView(
                allOf(withId(R.id.button4), withText("Back to main menu"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
